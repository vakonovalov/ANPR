...
//        public abstract void BackPropagate(double[] networkOutput);
    ...
    public class NeuralNW
    {
        ...
        /* инициализирует сеть, изменяя ее весовые коэффициенты. 
           x, y - обучающая пара.
         */
        ...
        /* обучает сеть, изменяя ее весовые коэффициенты. (стандартный метод) 
         *   x, y - обучающая пара. 
         *   klern - скорость обучения
         */
        //Первый индекс у массивов - номер входного примера
        ...
        /* обучает сеть, изменяя ее весовые коэффициенты. (разбитие обучающей выборки на партии) 
         *   x, y - обучающая пара. 
         *   klern - скорость обучения
